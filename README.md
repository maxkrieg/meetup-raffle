Very small React app that pulls a list of RSVPs from the meetup api using a signed url, and then randomly selects a person from that list as the `raffle winner`.
